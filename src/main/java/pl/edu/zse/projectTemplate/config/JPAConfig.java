/*
package pl.edu.zse.projectTemplate.config;
...
@Configuration
@EnableJpaRepositories("pl.edu.zse.projectTemplate.repositiories")
@EnableTransactionManagement
public class JPAConfig {
    @Bean
    public DataSource getDataSource() {
        DataSourceBuilder<?> dataSourceBuilder = DataSourceBuilder.create();
        dataSourceBuilder.url("jdbc:mysql://localhost:3306/karty" +
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource, HibernateJpaVendorAdapter jpaVendorAdapter) {
        ...
        entityManagerFactory.setPackagesToScan(
                "pl.edu.zse.projectTemplate.model"
        );
